...
Le seul paramètre est la pente de la droite, égale à 85 environ.
...
> La transformation logarithmique $\ln(S) = \beta_0 + \beta_1 \ln(A) $ permet d'estimer z au lieu de fixer sa valeur. 
...
Du bas vers le haut, le gradient va d'un climat chaud (température moyenne et maximale élevées), avec des précipitations inégales, à une climat froid avec au moins un mois sec.
